...
import { sideBarBotttomLinks, sideBarLinks } from "../navigations/Navigations";
...
function SideBar() {
  ...
  return (
    <nav className="bg-secondary w-full  h-full flex lg:flex-col lg:max-w-[20dvw] justify-between gap-4 lg:gap-8 p-4">
